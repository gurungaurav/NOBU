...
export default function SpecificBookingDetails() {
  const { hotel_name, booking_id } = useParams();
  ...
  const getBookingDetails = async () => {
    try {
      ...
      if (details.status === "refund") {
        ...
        setRefundedOldAmount(parseInt(details.total_price) + originalAmount);
      }
    } catch (e) {
      console.log(e);
    }
  ...
  const navigateReturn = () => {
    navigate(`/vendor/${hotel_name}/bookingLists`);
  };
  return (
